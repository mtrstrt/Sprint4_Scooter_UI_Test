...
public class OrderTestFireFox {
    ...
    public OrderTestFireFox(String buttonType, String firstName, String lastName, String address, String metroStation, String phone, String date, String rentalPeriod, String color, String comment) {
    ...
    @Parameterized.Parameters(name = "Firefox: Заказ через кнопку {0}: {1} {2}")
